...
import { FieldName, FieldValues, RegisterOptions, useForm, UseFormReturn } from 'react-hook-form';
...
function Input({
  ...
  validations: RegisterOptions<FieldValues, FieldName<FieldValues>>;
  errorMessage?: string;
}) {
    ...
    <fieldset>
      ...
      {Object.entries(options).map(([id, label]) => (
        <div key={id} className="control checkbox">
          ...
          <input type="checkbox" id={id} value={id} {...form.register(name)} />
        </div>
      ))}
    </fieldset>
  );
